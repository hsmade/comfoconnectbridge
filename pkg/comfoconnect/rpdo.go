...
func NewPpid(ppid uint32, data []byte) RpdoTypeConverter {
	...
	case 66:
		return RpdoType1{rpdoType{ppid, "Bypass activation mode (`00` = auto, `01` = activated, `02` = deactivated)"}, data}
	case 67:
		return RpdoType1{rpdoType{ppid, "Temperature Profile (`00` = normal, `01` = cold, `02` = warm)"}, data}
	case 70:
		return RpdoType1{rpdoType{ppid, "Unknown"}, data}
	case 71:
		return RpdoType1{rpdoType{ppid, "Unknown"}, data}
